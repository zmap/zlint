...
func init() {
	lint.RegisterLint(&lint.Lint{
		...
		Description:   "The encoded AlgorithmIdentifier for RSASSA-PSS in the signature algorithm MUST match specific hex-encoded bytes",
