...
func (l *pssAidEncoding) Initialize() error {
	return nil
}

func (l *pssAidEncoding) CheckApplies(c *x509.Certificate) bool {
	return c.SignatureAlgorithmOID.Equal(util.OidRSASSAPSS)
}

func (l *pssAidEncoding) Execute(c *x509.Certificate) *lint.LintResult {
	...
	return &lint.LintResult{Status: lint.Error, Details: "PSS parameters are not properly encoded"}
}

func init() {
	lint.RegisterLint(&lint.Lint{
		Name:          "e_mp_pss_parameters_encoding_correct",
