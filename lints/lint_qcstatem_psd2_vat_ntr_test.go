...
func TestQcStatemPsd2VatNtr(t *testing.T) {
	m := map[string]LintStatus{
		...
		"QcStmtPsd2Cert42OrgIdInvalid.pem":               Error,
		"QcStmtPsd2Cert43LeiNotXg.pem":                   Error,
		"QcStmtPsd2Cert44ValidNtr.pem":                   Pass,
		"QcStmtPsd2Cert45LegalPersonSyntaxViolated.pem":  NA,
		"QcStmtPsd2Cert46InvalidOrgIdNtr.pem":            Error,
		"QcStmtPsd2Cert47MissingUri.pem":                 NA,
		"QcStmtPsd2Cert50CabfNtrSopSyntaxInPsd2Cert.pem": Error,
		"EvAltRegNumCert57NtrJurSopMissing.pem":          NA,
	}
	for inputPath, expected := range m {
		inputPath = "../testlint/testCerts/" + inputPath
		out := Lints["e_qcstatem_psd2_vat_ntr"].Execute(ReadCertificate(inputPath))
