 ...
 */
static asn_oer_constraints_t asn_OER_type_PredefinedBiometricType_constr_1 CC_NOTUSED = {
	{ 1, 1 }	/* (0..1) */,
	-1};
asn_per_constraints_t asn_PER_type_PredefinedBiometricType_constr_1 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_PredefinedBiometricType = {
	...
	sizeof(asn_DEF_PredefinedBiometricType_tags_1)
		/sizeof(asn_DEF_PredefinedBiometricType_tags_1[0]), /* 1 */
	{ &asn_OER_type_PredefinedBiometricType_constr_1, &asn_PER_type_PredefinedBiometricType_constr_1, PredefinedBiometricType_constraint },
