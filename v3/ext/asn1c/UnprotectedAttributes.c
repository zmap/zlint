...
static asn_oer_constraints_t asn_OER_type_UnprotectedAttributes_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..MAX)) */};
asn_per_constraints_t asn_PER_type_UnprotectedAttributes_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_SEMI_CONSTRAINED,	-1, -1,  1,  0 }	/* (SIZE(1..MAX)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_UnprotectedAttributes_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_UnprotectedAttributes_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_UnprotectedAttributes = {
	...
	sizeof(asn_DEF_UnprotectedAttributes_tags_1)
		/sizeof(asn_DEF_UnprotectedAttributes_tags_1[0]), /* 1 */
	{ &asn_OER_type_UnprotectedAttributes_constr_1, &asn_PER_type_UnprotectedAttributes_constr_1, SET_OF_constraint },
