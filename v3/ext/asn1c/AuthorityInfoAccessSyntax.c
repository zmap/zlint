...
static asn_oer_constraints_t asn_OER_type_AuthorityInfoAccessSyntax_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..MAX)) */};
asn_per_constraints_t asn_PER_type_AuthorityInfoAccessSyntax_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_SEMI_CONSTRAINED,	-1, -1,  1,  0 }	/* (SIZE(1..MAX)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_AuthorityInfoAccessSyntax_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_AuthorityInfoAccessSyntax_specs_1 = {
