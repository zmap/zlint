...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_mp_rsassa-pss_parameters_encoding_in_signature_algorithm_correct",
		...
		EffectiveDate: util.MozillaPolicy27Date}, Lint: NewRsaPssAidEncoding})
