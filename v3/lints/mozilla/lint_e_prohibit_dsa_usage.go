...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_prohibit_dsa_usage",
		...
		EffectiveDate: util.MozillaPolicy241Date}, Lint: NewProhibitDSAUsage})
