...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_rsa_key_usage_legacy_multipurpose",
		...
		EffectiveDate: util.CABF_SMIME_BRs_1_0_0_Date}, Lint: NewRSAKeyUsageLegacyMultipurpose})
