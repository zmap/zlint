...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_ecpublickey_key_usages",
		...
		EffectiveDate: util.CABF_SMIME_BRs_1_0_0_Date}, Lint: NewECPublicKeyKeyUsages})
