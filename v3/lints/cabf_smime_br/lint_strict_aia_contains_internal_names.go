...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "w_smime_strict_aia_contains_internal_names",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewSMIMEStrictAIAInternalName})
