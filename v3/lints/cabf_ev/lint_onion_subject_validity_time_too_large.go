...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_onion_subject_validity_time_too_large",
		...
		EffectiveDate: util.OnionOnlyEVDate}, Lint: NewTorValidityTooLarge})
