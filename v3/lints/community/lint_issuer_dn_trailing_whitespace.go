...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "w_issuer_dn_trailing_whitespace",
		...
		EffectiveDate: util.ZeroDate}, Lint: NewIssuerDNTrailingSpace})
