...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_distribution_point_incomplete",
		...
		Source:        lint.RFC5280,
		EffectiveDate: util.RFC3280Date}, Lint: NewDpIncomplete})
