...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "w_ext_aia_access_location_missing",
		...
		Source:        lint.RFC5280,
		EffectiveDate: util.RFC5280Date}, Lint: NewAiaNoHTTPorLDAP})
