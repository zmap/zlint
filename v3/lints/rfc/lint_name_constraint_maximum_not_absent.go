...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_name_constraint_maximum_not_absent",
		...
		Source:        lint.RFC5280,
		EffectiveDate: util.RFC2459Date}, Lint: NewNameConstraintMax})
