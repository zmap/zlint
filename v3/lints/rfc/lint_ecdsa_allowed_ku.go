...
*/
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_ecdsa_allowed_ku",
		...
		Source:        lint.RFC8813,
		EffectiveDate: util.RFC8813Date}, Lint: NewEcdsaAllowedKU})
