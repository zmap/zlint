...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "n_ecdsa_ee_invalid_ku",
		...
		Source:        lint.RFC5480,
		EffectiveDate: util.CABEffectiveDate}, Lint: NewEcdsaInvalidKU})
