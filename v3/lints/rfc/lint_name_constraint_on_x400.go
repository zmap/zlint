...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "w_name_constraint_on_x400",
		...
		Source:        lint.RFC5280,
		EffectiveDate: util.RFC5280Date}, Lint: NewNameConstraintOnX400})
