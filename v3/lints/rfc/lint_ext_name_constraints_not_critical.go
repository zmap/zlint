...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_ext_name_constraints_not_critical",
		...
		Source:        lint.RFC5280,
		EffectiveDate: util.RFC2459Date}, Lint: NewNameConstraintCrit})
