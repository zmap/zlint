...
func init() {
	lint.RegisterLint(&lint.Lint{
		...
		Description:   "For URIs, the constraint MUST be specified as a fully qualified domain name [...] When the constraint begins with a period, it MAY be
   expanded with one or more labels.",
