...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_superfluous_ku_encoding",
		...
		Source:        lint.RFC5280,
		EffectiveDate: util.ZeroDate}, Lint: func() lint.LintInterface { return &superfluousKuEncoding{} }})
