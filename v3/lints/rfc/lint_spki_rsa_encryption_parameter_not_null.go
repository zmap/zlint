...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_spki_rsa_encryption_parameter_not_null",
		...
		EffectiveDate: util.RFC5280Date}, Lint: NewRsaSPKIEncryptionParamNotNULL})
