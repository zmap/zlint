...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "w_tls_server_cert_valid_time_longer_than_397_days",
		...
		EffectiveDate: util.AppleReducedLifetimeDate}, Lint: NewServerCertValidityAlmostTooLong})
