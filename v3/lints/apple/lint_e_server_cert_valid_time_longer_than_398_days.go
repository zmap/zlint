...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_tls_server_cert_valid_time_longer_than_398_days",
		...
		EffectiveDate: util.AppleReducedLifetimeDate}, Lint: NewServerCertValidityTooLong})
