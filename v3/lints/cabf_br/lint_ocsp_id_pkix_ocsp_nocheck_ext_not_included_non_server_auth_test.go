...
func TestOCSPIDPKIXOCSPNocheckExtNotIncludedNonServerAuth(t *testing.T) {
	testCases := []struct {
		Name           string
		Filename       string
	...
	for _, tc := range testCases {
		t.Run(tc.Name, func(t *testing.T) {
			result := test.TestLint("w_ocsp_id_pkix_ocsp_nocheck_ext_not_included_non_server_auth", tc.Filename)
