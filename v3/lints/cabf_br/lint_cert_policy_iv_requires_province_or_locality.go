...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_cert_policy_iv_requires_province_or_locality",
		...
		EffectiveDate: util.CABV131Date}, Lint: NewCertPolicyIVRequiresProvinceOrLocal})
