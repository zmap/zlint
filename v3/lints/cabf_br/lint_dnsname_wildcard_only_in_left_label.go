...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_dnsname_wildcard_only_in_left_label",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewDNSNameWildcardOnlyInLeftlabel})
