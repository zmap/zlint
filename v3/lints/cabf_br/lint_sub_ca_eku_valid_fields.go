...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "n_sub_ca_eku_not_technically_constrained",
		...
		EffectiveDate: util.CABV116Date}, Lint: NewSubCAEKUValidFields})
