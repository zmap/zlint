...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_sub_cert_basic_constraints_not_critical",
		...
		EffectiveDate: util.SC62EffectiveDate}, Lint: NewSubCertBasicConstCrit})
