...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_sub_cert_eku_server_auth_client_auth_missing",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewSubExtKeyUsageClientOrServer})
