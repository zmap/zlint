...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_sub_cert_cert_policy_empty",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewSubCertPolicyEmpty})
