...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_cab_dv_conflicts_with_locality",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewCertPolicyConflictsWithLocality})
