...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_cert_policy_ov_requires_country",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewCertPolicyOVRequiresCountry})
