...
func TestSC081FirstDate199ServerCertValidityTooLong(t *testing.T) {
	testCases := []struct {
		...
		{
			Name:           "Warn - certificate is issued at 20260315 000000, exactly on the first date and has the the full 200-day validity",
		...
		{
			Name:           "NE - certificate is issued at 20270315 000000, exactly on the the second date and has a full 100-day validity",
