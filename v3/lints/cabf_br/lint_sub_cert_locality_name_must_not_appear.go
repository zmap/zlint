...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_sub_cert_locality_name_must_not_appear",
		...
		EffectiveDate: util.CABGivenNameDate}, Lint: NewSubCertLocalityNameMustNotAppear})
