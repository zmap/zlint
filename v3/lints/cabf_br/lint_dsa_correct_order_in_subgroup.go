...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_dsa_correct_order_in_subgroup",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewDsaSubgroup})
