...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_sub_cert_country_name_must_appear",
		...
		EffectiveDate: util.CABGivenNameDate}, Lint: NewSubCertCountryNameMustAppear})
