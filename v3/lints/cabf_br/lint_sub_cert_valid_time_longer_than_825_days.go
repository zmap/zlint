...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_sub_cert_valid_time_longer_than_825_days",
		...
		EffectiveDate: util.SubCert825Days}, Lint: NewSubCertValidTimeLongerThan825Days})
