...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_underscore_present_with_too_long_validity",
		...
		IneffectiveDate: util.CABFBRs_1_6_2_UnderscorePermissibilitySunsetDate}, Lint: func() lint.LintInterface { return &UnderscorePresentWithTooLongValidity{} }})
