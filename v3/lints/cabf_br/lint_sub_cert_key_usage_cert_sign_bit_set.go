...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_sub_cert_key_usage_cert_sign_bit_set",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewSubCertKeyUsageBitSet})
