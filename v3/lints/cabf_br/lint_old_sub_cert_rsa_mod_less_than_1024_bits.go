...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_old_sub_cert_rsa_mod_less_than_1024_bits",
		...
		EffectiveDate: util.ZeroDate}, Lint: NewSubModSize})
