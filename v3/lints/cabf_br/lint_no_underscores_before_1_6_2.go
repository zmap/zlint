...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_no_underscores_before_1_6_2",
		...
		IneffectiveDate: util.CABFBRs_1_6_2_Date}, Lint: func() lint.LintInterface { return &NoUnderscoreBefore1_6_2{} }})
