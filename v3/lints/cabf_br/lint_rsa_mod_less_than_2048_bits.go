...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_rsa_mod_less_than_2048_bits",
		...
		EffectiveDate: util.ZeroDate}, Lint: NewRsaParsedTestsKeySize})
