...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_ec_improper_curves",
		...
		EffectiveDate: util.ZeroDate}, Lint: NewEcImproperCurves})
