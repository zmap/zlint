...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "w_sub_cert_sha1_expiration_too_long",
		...
		EffectiveDate: util.CABFBRs_1_2_1_Date}, Lint: NewSha1ExpireLong})
