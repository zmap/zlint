...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_sub_cert_crl_distribution_points_does_not_contain_url",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewSubCRLDistNoURL})
