...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "e_ext_tor_service_descriptor_hash_invalid",
		...
		EffectiveDate: util.CABV201Date}, Lint: NewTorServiceDescHashInvalid})
