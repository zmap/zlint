...
func init() {
	lint.RegisterCertificateLint(&lint.CertificateLint{LintMetadata: lint.LintMetadata{Name: "w_sub_ca_aia_does_not_contain_issuing_ca_url",
		...
		EffectiveDate: util.CABEffectiveDate}, Lint: NewSubCaIssuerUrl})
